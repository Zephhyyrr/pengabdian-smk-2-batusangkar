...
interface UpdateKomoditasFormProps {
    isOpen: boolean;
    onClose: () => void;
}

export default function UpdateKomoditasForm({ isOpen, onClose }: UpdateKomoditasFormProps) {
        ...
        >
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-xl w-full max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center p-4 border-b dark:border-gray-700">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">Update Komoditas</h3>
                    <button
